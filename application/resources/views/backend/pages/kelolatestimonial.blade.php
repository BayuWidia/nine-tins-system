...
@section('breadcrumb')
  <h1>
    Testimonial
    <small>Kelola Testimonial</small>
  </h1>
  <ol class="breadcrumb">
...
@section('content')
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Edit Status Testimonial</h4>
        </div>
        <div class="modal-body">
          <p>Apakah anda yakin untuk mengubah status testimonial ini?</p>
        </div>
  ...
  <div class="modal fade" id="modaldelete" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Hapus Testimonial</h4>
        </div>
        <div class="modal-body">
          <p>Apakah anda yakin untuk menghapus testimonial ini?</p>
        </div>
        <div class="modal-footer">
          <button type="reset" class="btn btn-default pull-left btn-flat" data-dismiss="modal">Tidak</button>
  ...
  <div class="modal fade" id="modaledit" role="dialog">
    <div class="modal-dialog">
      <form class="form-horizontal" action="{{route('testimonial.edit')}}" method="post" enctype="multipart/form-data">
        {{csrf_field()}}
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">Edit Konten Testimonial</h4>
          </div>
          <div class="modal-body">
            <div class="col-md-14">
              <label class="control-label">Nama Testimonial</label>
              <input type="text" name="nama_testimonial" class="form-control" id="edit_nama_testimonial">
            </div>
            <div class="col-md-14">
              <label class="control-label">Keterangan</label>
              <textarea name="keterangan_testimonial" rows="4" cols="40" class="form-control" id="edit_keterangan_testimonial"></textarea>
            </div>
            <div class="col-md-14">
              <label class="control-label">Gambar Testimonial</label>
              <input type="file" name="url_testimonial" class="form-control">
              <input type="hidden" name="id" id="id">
              <span style="color:red;">* Biarkan kosong jika tidak ingin diganti.</span>
            </div>
            <div class="col-md-14">
              <label class="control-label">Status</label>
              <select class="form-control" name="flag_testimonial">
      ...
      <form class="form-horizontal" action="{{route('testimonial.store')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Formulir Tambah Testimonial Baru</h3>
          </div>
          <div class="box-body">
            <div class="col-md-14">
              <label class="control-label">Nama Testimonial</label>
              <input type="text" name="nama_testimonial" class="form-control">
            </div>
            <div class="col-md-14">
              <label class="control-label">Keterangan</label>
              <textarea name="keterangan_testimonial" rows="4" cols="40" class="form-control"></textarea>
            </div>
            <div class="col-md-14">
              <label class="control-label">Gambar Testimonial</label>
              <input type="file" name="url_testimonial" class="form-control">
    ...
    <div class="col-md-8">
      <div class="box box-primary">
        <div class="box-header">
          <h3 class="box-title">Seluruh Data Testimonial</h3>
        </div><!-- /.box-header -->
        <div class="box-body">
            ...
            <tbody>
              ...
              @foreach($gettestimonial as $key)
                <tr>
                  ...
                  <td>{{$key->keterangan_testimonial}}</td>
                  <td>
                    @if($key->url_testimonial!="")
                      <?php $gambar = explode(".", $key->url_testimonial) ?>
                      <img src="{{url('images/')}}/{{$gambar[0]}}_200x122.{{$gambar[1]}}"></td>
                    @else
                      <img src="{{url('images/')}}/no_image.jpg"></td>
                    @endif
                  <td>
                    @if($key->flag_testimonial=="1")
  ...
  <script>
    $(function () {
      ...
      $("#tabelinfo").on("click", "a.flagpublish", function(){
        ...
        $('#setflagpublish').attr('href', '{{url('admin/publish-testimonial/')}}/'+a);
      });

      $("#tabelinfo").on("click", "a.hapus", function(){
        var a = $(this).data('value');
        $('#sethapus').attr('href', '{{url('admin/delete-testimonial/')}}/'+a);
      });

      $("#tabelinfo").on("click", "a.edit", function(){
        var a = $(this).data('value');
        $.ajax({
          url: "{{url('/')}}/admin/bind-testimonial/"+a,
          dataType: 'json',
          success: function(data){
            var id = data.id;
            var nama_testimonial = data.nama_testimonial;
            var keterangan_testimonial = data.keterangan_testimonial;
            var flag_testimonial = data.flag_testimonial;

            $('#id').attr('value', id);
            $('#edit_nama_testimonial').val(nama_testimonial);
            $('#edit_keterangan_testimonial').val(keterangan_testimonial);
            if(flag_testimonial=="1") {

...
@section('breadcrumb')
  <h1>
    ...
    <small>Kategori Bagi Pengetahuan</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="{{url('backend/dashboard')}}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
    <li class="active">Kategori Bagi Pengetahuan</li>
  </ol>
@stop
...
@section('content')
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Hapus Data Kategori Bagi Pengetahuan</h4>
        </div>
  ...
  <div class="modal fade" id="modalflagedit" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Edit Status Kategori Bagi Pengetahuan</h4>
        </div>
        <div class="modal-body">
          <p>Apakah anda yakin untuk mengubah status kategori ini?</p>
        </div>
        <div class="modal-footer">
          <button type="reset" class="btn btn-default pull-left btn-flat" data-dismiss="modal">Tidak</button>
  ...
  <div class="modal fade" id="modaledit" role="dialog">
    <div class="modal-dialog">
      <form class="form-horizontal" action="{{route('pengetahuan.kategori.edit')}}" method="post">
        {{ csrf_field() }}
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">Edit Kategori Bagi Pengetahuan</h4>
          </div>
          <div class="modal-body">
            <div class="col-md-14 ">
  ...
  <div class="row">
    ...
    <form class="form-horizontal" action="{{route('pengetahuan.kategori.store')}}" method="post">
      {{ csrf_field() }}
      <div class="col-md-4">
    ...
    <div class="col-md-8">
      <div class="box box-success">
        <div class="box-header with-border">
          <h3 class="box-title">List Data Kategori Bagi Pengetahuan</h3>
        </div>
  ...
  <script type="text/javascript">
    $(function(){
      $('a.flagedit').click(function(){
        ...
        $('#setflagedit').attr('href', '{{url('admin/change-status-kategori-bagi-pengetahuan/')}}/'+a);
      });

      $('a.hapus').click(function(){
        var a = $(this).data('value');
        $('#sethapus').attr('href', '{{url('admin/delete-kategori-bagi-pengetahuan//')}}/'+a);
      });

      $('a.edit').click(function(){
        var a = $(this).data('value');
        $.ajax({
          url: "{{url('/')}}/admin/bind-kategori-bagi-pengetahuan/"+a,
          dataType: 'json',
